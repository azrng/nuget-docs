import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,a as s}from"./app-173e4b57.js";const a={},l=s(`<h2 id="common-core" tabindex="-1"><a class="header-anchor" href="#common-core" aria-hidden="true">#</a> Common.Core</h2><h3 id="版本更新记录" tabindex="-1"><a class="header-anchor" href="#版本更新记录" aria-hidden="true">#</a> 版本更新记录</h3><ul><li><p>1.0.4</p><ul><li>迁移base64的扩展到StringExtension，并且改名为ToBase64Encode、FromBase64Decode</li><li>增加时间段和时间点相互转换代码</li><li>增加ExceptionExtension、DecimalExtension、DoublelExtension</li></ul></li><li><p>1.0.3</p><ul><li><p>增加任务运行时间限制方法，TaskHelper.RunTimeLimitAsync</p></li><li><p>增加字符串输出扩展</p></li></ul></li><li><p>1.0.2</p><ul><li>增加本地日志文件操作类</li></ul></li><li><p>1.0.1</p><ul><li>引用Newtonsoft.Json包，增加json操作扩展</li><li>将扩展方法的命名空间改为Common.Extension</li></ul></li><li><p>1.0.0</p><ul><li>将common中的部分类移动到该类库中</li></ul></li></ul><h2 id="common" tabindex="-1"><a class="header-anchor" href="#common" aria-hidden="true">#</a> Common</h2><h3 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h3><p>常见的公共类封库，继承自Common.Core</p><h3 id="操作" tabindex="-1"><a class="header-anchor" href="#操作" aria-hidden="true">#</a> 操作</h3><h4 id="扩展类" tabindex="-1"><a class="header-anchor" href="#扩展类" aria-hidden="true">#</a> 扩展类</h4><h5 id="字符串扩展" tabindex="-1"><a class="header-anchor" href="#字符串扩展" aria-hidden="true">#</a> 字符串扩展</h5><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>//判断字符串是否是数值类型
