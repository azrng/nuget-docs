...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="版本更新记录-13" tabindex="-1"><a class="header-anchor" href="#版本更新记录-13" aria-hidden="true">#</a> 版本更新记录</h3><blockquote><p>1.0.0 基本base实体类封装 1.0.1 增加注释操作</p></blockquote><h2 id="common-sqlsugar" tabindex="-1"><a class="header-anchor" href="#common-sqlsugar" aria-hidden="true">#</a> Common.SqlSugar</h2><h3 id="操作例子-10" tabindex="-1"><a class="header-anchor" href="#操作例子-10" aria-hidden="true">#</a> 操作例子</h3><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>services.AddSqlSugarService(() 
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="版本更新记录-19" tabindex="-1"><a class="header-anchor" href="#版本更新记录-19" aria-hidden="true">#</a> 版本更新记录</h3><ul><li><p>1.2.1</p><ul><li>升级包版本以及维护文档</li></ul></li><li><p>1.2.0-beta2</p><ul><li>将swagger使用迁移到该包中</li></ul></li><li><p>1.2.0-beta1</p><ul><li>升级支持net7</li><li>注入服务的方式更新</li></ul></li><li><p>1.1.3</p><ul><li><p>支持netcoreapp3.1;net5.0;net6.0</p></li><li><p>优化方法，增加校验token方法</p></li></ul></li></ul><blockquote><p>1.0.0 3.1版本的jwttoken公共库<br> 1.1.0 更新版本为5.0 1.1.1 拓展生成token的方法 1.1.2 配置多个目标框架</p></blockquote><hr><h2 id="common-qrcode" tabindex="-1"><a class="header-anchor" href="#common-qrcode" aria-hidden="true">#</a> Common.QRCode</h2><h3 id="操作例子-16" tabindex="-1"><a class="header-anchor" href="#操作例子-16" aria-hidden="true">#</a> 操作例子</h3><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>services.AddQrCode();
然后注入：IQrCodeHelp
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="版本更新记录-21" tabindex="-1"><a class="header-anchor" href="#版本更新记录-21" aria-hidden="true">#</a> 版本更新记录</h2><ul><li>0.0.1-beta2 <ul><li>更新一些知识库的操作</li></ul></li><li>0.0.1-beta1 <ul><li>基本的语雀api调用</li></ul></li></ul><h2 id="common-aliyunsms-未发布" tabindex="-1"><a class="header-anchor" href="#common-aliyunsms-未发布" aria-hidden="true">#</a> Common.AliyunSms(未发布)</h2><h1 id="介绍-4" tabindex="-1"><a class="header-anchor" href="#介绍-4" aria-hidden="true">#</a> 介绍</h1><p>该包封装了阿里云短信使用的公共类</p><h1 id="使用-1" tabindex="-1"><a class="header-anchor" href="#使用-1" aria-hidden="true">#</a> 使用</h1><h1 id="修改记录" tabindex="-1"><a class="header-anchor" href="#修改记录" aria-hidden="true">#</a> 修改记录</h1>`,18);function m(b,h){const n=r("ExternalLinkIcon");return t(),d("div",null,[u,e("blockquote",null,[e("p",null,[i("官方文档："),e("a",o,[i("https://www.yuque.com/yuque/developer/api"),a(n)])]),e("p",null,[i("Apifox文档："),e("a",p,[i("https://www.apifox.cn/apidoc/project-584301/api-10357086"),a(n)])])]),v])}const k=l(c,[["render",m],["__file","index.html.vue"]]);export{k as default};
