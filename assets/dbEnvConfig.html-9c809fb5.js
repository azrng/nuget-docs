import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,a as l}from"./app-9ba8c8d9.js";const d={};function r(s,e){return n(),a("div",null,e[0]||(e[0]=[l(`<h2 id="azrng-dbenvconfig" tabindex="-1"><a class="header-anchor" href="#azrng-dbenvconfig" aria-hidden="true">#</a> Azrng.DbEnvConfig</h2><p>一个数据库环境变量配置的封装，通过读取数据库的表中的配置，然后代码中直接可以通过IConfiguration来获取内容</p><h3 id="功能" tabindex="-1"><a class="header-anchor" href="#功能" aria-hidden="true">#</a> 功能</h3><ul><li>数据库配置导入IConfiguration</li><li>支持已有配置表导入</li><li>支持IDbConnection的数据库，比如pgsql、sqlserver、mysql等</li><li>支持自定义初始化表语句</li><li>支持自定义初始化表数据</li><li>支持查询配置语句自定义筛选条件</li></ul><h3 id="操作例子" tabindex="-1"><a class="header-anchor" href="#操作例子" aria-hidden="true">#</a> 操作例子</h3><h4 id="pgsql使用默认配置表" tabindex="-1"><a class="header-anchor" href="#pgsql使用默认配置表" aria-hidden="true">#</a> pgsql使用默认配置表</h4><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>var connStr = builder.Configuration[&quot;ConnStr&quot;];
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="版本更新记录" tabindex="-1"><a class="header-anchor" href="#版本更新记录" aria-hidden="true">#</a> 版本更新记录</h3><ul><li>1.0.0-未发布 <ul><li>支持数据库环境变量配置</li></ul></li></ul>`,14)]))}const o=i(d,[["render",r],["__file","dbEnvConfig.html.vue"]]);export{o as default};
