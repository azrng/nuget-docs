import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as e,a as i}from"./app-9ba8c8d9.js";const t={};function o(l,n){return s(),e("div",null,n[0]||(n[0]=[i(`<h2 id="azrng-s3store" tabindex="-1"><a class="header-anchor" href="#azrng-s3store" aria-hidden="true">#</a> Azrng.S3Store</h2><p>一个基于AWSSDK.S3包适用于S3协议的存储封装类库。</p><h3 id="操作示例" tabindex="-1"><a class="header-anchor" href="#操作示例" aria-hidden="true">#</a> 操作示例</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>services.AddS3Store(x =&gt;
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在项目中使用该服务，那么就可以通过注册IStore来调用方法</p><h3 id="版本更新记录-1" tabindex="-1"><a class="header-anchor" href="#版本更新记录-1" aria-hidden="true">#</a> 版本更新记录</h3><ul><li>1.0.0-beta3-未发布 <ul><li>迁移项目目录</li><li>支持minio适配不安全https问题</li></ul></li><li>1.0.0-beta2 <ul><li>增加支持.Net7、.Net8框架</li><li>支持连接字符串方案</li></ul></li><li>1.0.0-beta1 <ul><li>基础操作</li></ul></li></ul>`,13)]))}const d=a(t,[["render",o],["__file","commonMinioStore.html.vue"]]);export{d as default};
