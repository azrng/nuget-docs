import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as s,a as l}from"./app-9ba8c8d9.js";const a={};function t(d,e){return n(),s("div",null,e[0]||(e[0]=[l(`<h2 id="common-core" tabindex="-1"><a class="header-anchor" href="#common-core" aria-hidden="true">#</a> Common.Core</h2><h3 id="操作" tabindex="-1"><a class="header-anchor" href="#操作" aria-hidden="true">#</a> 操作</h3><h4 id="objectextensions" tabindex="-1"><a class="header-anchor" href="#objectextensions" aria-hidden="true">#</a> ObjectExtensions</h4><p>模型类转url参数格式(1.0.5)</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>var userInfo = new UserInfoDto { Id = 1, Name = &quot;Test&quot;, };
// 参数不转小写
var result = userInfo.ToUrlParameter();// Id=1&amp;Name=Test
// 参数转小写
var result = userInfo.ToUrlParameter(true);// id=1&amp;name=Test
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="版本更新记录" tabindex="-1"><a class="header-anchor" href="#版本更新记录" aria-hidden="true">#</a> 版本更新记录</h3><ul><li>1.2.1 <ul><li>增加排序url参数值 UriHelper.SortUrlParameters，调整url扩展方法和帮助类</li><li>日志帮助类增加修改日志输出的级别</li><li>日志帮助类增加超过7天自动删除</li><li>增加IJsonSerializer接口</li><li>增加sql安全检测帮助类</li><li>在HtmlHelper下增加HtmlToText</li><li>DateTimeHelper下增加GetTimeDifferenceText</li><li>增加CsvHelper</li><li>调整部分扩展方法目录</li></ul></li><li>1.2.0 <ul><li>移除包Newtonsoft.Json的依赖</li><li>更新获取网络时间的接口API</li><li>禁用部分涉及到序列化的方法</li></ul></li><li>1.1.6 <ul><li>修复GetColumnValueByName方法bug</li><li>支持.Net9</li></ul></li><li>1.1.5 <ul><li>修改GetColumnValueByName方法bug</li></ul></li><li>1.1.4 <ul><li>增加IEnumerable的WithIndex扩展</li><li>ApplicationHelper类增加RuntimeInfo方法</li><li>优化IO操作方法</li></ul></li><li>1.1.3 <ul><li>字典增加GetOrDefault扩展方法</li><li>调整Guard中message和参数的顺序</li></ul></li><li>1.1.2 <ul><li>更新时间扩展，增加 DateTime?.ToDateString、DateTime?.ToStandardString</li><li>将一部分方法抽离到DateTimeHelper中，防止扩展污染</li><li>修改where筛选QueryableWhereIF为QueryableWhereIf</li></ul></li><li>1.1.1 <ul><li>增加默认无参数的ToStandardString</li><li>增加将时间转年月日：ToDateString</li><li>增加Guard帮助类，使用方法比如Guard.Against.Null(&quot;输入值&quot;, &quot;参数名&quot;);</li><li>增加Console的输出ReadLineWithPrompt、ReadKeyWithPrompt</li><li>增加ApplicationHelper应用程序帮助类</li><li>将LongHelper改名为NumberHelper</li><li>增加获取无时区的当前时间</li></ul></li><li>1.1.0 <ul><li>优化ResultModel类，增加Failure方法</li></ul></li><li>1.0.10 <ul><li>增加AsyncHelper执行同步方法</li><li>移除获取时间戳弃用的方法</li><li>增加CollectionHelper支持分页批次处理数据</li><li>增加FileHelper.FormatFileSize</li></ul></li><li>1.0.9 <ul><li>获取特殊文件夹之桌面文件路径</li><li>增加检查文件是否被其他进程锁定方法</li><li>增加获取NTP网络远程时间</li><li>增加系统操作：获取本机ip、ipv4地址、ipv6地址</li><li>增加MimeExtensions扩展</li></ul></li><li>1.0.8 <ul><li>升级支持.net8</li></ul></li><li>1.0.7 <ul><li>更新ICurrentUser默认为string类型UserId</li></ul></li><li>1.0.6 <ul><li>增加程序集扩展方法和程序集帮助类以及获取所有程序集的方法</li><li>增加枚举帮助类EnumHelper，迁移枚举扩展中部分方法到枚举帮助类中</li><li>枚举扩展类中方法GetDescriptionString改名GetDescription</li></ul></li><li>1.0.5 <ul><li>增加Random的NextDouble扩展方法</li><li>支持框架net6.0;net7.0</li></ul></li><li>1.0.4 <ul><li>迁移base64的扩展到StringExtension，并且改名为ToBase64Encode、FromBase64Decode</li><li>增加时间段和时间点相互转换代码</li><li>增加ExceptionExtension、DecimalExtension、DoublelExtension</li></ul></li><li>1.0.3 <ul><li><p>增加任务运行时间限制方法，TaskHelper.RunTimeLimitAsync</p></li><li><p>增加字符串输出扩展</p></li></ul></li><li>1.0.2 <ul><li>增加本地日志文件操作类</li></ul></li><li>1.0.1 <ul><li>引用Newtonsoft.Json包，增加json操作扩展</li><li>将扩展方法的命名空间改为Common.Extension</li></ul></li><li>1.0.0 <ul><li>将common中的部分类移动到该类库中</li></ul></li></ul><h2 id="common" tabindex="-1"><a class="header-anchor" href="#common" aria-hidden="true">#</a> Common</h2><p>常见的公共类封库，继承自Common.Core</p><h3 id="操作-1" tabindex="-1"><a class="header-anchor" href="#操作-1" aria-hidden="true">#</a> 操作</h3><h4 id="扩展类" tabindex="-1"><a class="header-anchor" href="#扩展类" aria-hidden="true">#</a> 扩展类</h4><h5 id="字符串扩展" tabindex="-1"><a class="header-anchor" href="#字符串扩展" aria-hidden="true">#</a> 字符串扩展</h5><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>//判断字符串是否是数值类型
