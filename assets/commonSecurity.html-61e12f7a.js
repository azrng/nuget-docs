...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Des加密算法：DesHelper</p><p>Rsa非对称加密算法：RsaHelper</p><p>Sm2非对称加密算法：Sm2Helper</p><p>Sm3哈希算法：Sm3Helper</p><p>Sm4对称加密算法：Sm4Helper</p><h2 id="更新记录" tabindex="-1"><a class="header-anchor" href="#更新记录" aria-hidden="true">#</a> 更新记录</h2><ul><li><p>1.0.0</p><ul><li>升级依赖包</li></ul></li><li><p>0.0.1-beta7</p><ul><li>对AES加密算法优化</li></ul></li><li><p>0.0.1-beta6</p><ul><li>替换依赖包BouncyCastle.NetCore为BouncyCastle.Cryptography，且将里面的一些源码操作改为使用包的方法，性能更好</li></ul></li><li><p>0.0.1-beta5</p><ul><li>增加SHA的HMAC算法</li></ul></li><li><p>0.0.1-beta4</p><ul><li>增加sm3、rsa等示例，增加单元测试</li></ul></li><li><p>0.0.1-beta3</p><ul><li>支持MD5、SHA等、DES、AES、RSA等</li></ul></li><li><p>0.0.1-beta2</p><ul><li>fix处理md5加密将16位和32位弄混问题</li></ul></li><li><p>0.0.1-beta1</p><ul><li>从common里面移出来一些方法</li></ul></li></ul>`,14)]))}const p=i(n,[["render",r],["__file","commonSecurity.html.vue"]]);export{p as default};
