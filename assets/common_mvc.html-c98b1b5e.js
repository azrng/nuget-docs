import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as s,a}from"./app-382f7186.js";const i={},l=a(`<h2 id="说明" tabindex="-1"><a class="header-anchor" href="#说明" aria-hidden="true">#</a> 说明</h2><p>常见的Asp.NetCore里面辅助方法</p><h2 id="操作" tabindex="-1"><a class="header-anchor" href="#操作" aria-hidden="true">#</a> 操作</h2><h3 id="扩展类" tabindex="-1"><a class="header-anchor" href="#扩展类" aria-hidden="true">#</a> 扩展类</h3><h4 id="httpcontext扩展" tabindex="-1"><a class="header-anchor" href="#httpcontext扩展" aria-hidden="true">#</a> HttpContext扩展</h4><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>var iPv4 = HttpContext.GetLocalIpAddressToIPv4();
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后使用中间件</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>app.UseShowAllServicesMiddleware();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="版本更新记录" tabindex="-1"><a class="header-anchor" href="#版本更新记录" aria-hidden="true">#</a> 版本更新记录</h2><ul><li><p>0.0.1-beta8</p><ul><li>修复MinValue特性bug</li></ul></li><li><p>0.0.1-beta7</p><ul><li>增加RequestBodyAsync扩展，以及增加请求体重复读取中间件</li><li>优化模型校验方法</li></ul></li><li><p>0.0.1-beta6</p><ul><li>升级支持.net8</li></ul></li><li><p>0.0.1-beta5</p><ul><li>修复批量注入的问题</li></ul></li><li><p>0.0.1-beta4</p><ul><li>增加HttpContext的扩展，例如获取远程IP、本地IP</li><li>增加CollectionNotEmpty、MinValue特性</li><li>迁移ServiceCollectionExtension</li><li>增加services.AddMvcModelVerifyFilter 模型校验过滤器</li><li>增加services.AddMvcResultPackFilterFilter返回值包装过滤器</li></ul></li><li><p>0.1.0-beta3</p><ul><li><p>支持.net8</p></li><li><p>支持显示所有服务以及服务注入的生命周期</p></li></ul></li><li><p>0.1.0-beta2</p><ul><li>优化代码</li></ul></li><li><p>0.1.0-beta1</p><ul><li>升级支持.net7</li></ul></li><li><p>0.0.1-beta6</p><ul><li><p>考虑到该包只能在API层使用，所以移除增加appsettings、cron帮助类、HttpContextManager、HttpContextExtensions、ServiceProviderHelper、SessionHelper、ICurrentUser、BaseService到AzrngCommon包</p></li><li><p>异常处理中间件增加请求日志输出</p></li><li><p>优化AppSettings写法</p></li><li><p>增加了如果是FileContentResult，那么就不包装返回</p></li><li><p>如果没有注入配置，那么就使用默认的CommonMvcConfig配置</p></li></ul></li><li><p>0.0.1-beta5</p><ul><li><p>优化AddDefaultControllers方法，返回值修改为IMvcBuilder</p></li><li><p>公共返回包装的方法优化对415错误的处理，遇到415错误的时候，直接返回不再包装</p></li></ul></li><li><p>0.0.1-beta4</p><ul><li><p>优化支持的框架版本，支持3.1、5.0、6.0</p></li><li><p>增加默认的控制器处理，必须添加AddDefaultControllers操作</p></li></ul></li><li><p>0.0.1-beta3</p><ul><li>优化支持的框架版本，支持3.1、5.0、6.0</li><li>将cors默认全部允许继承，直接使用services.AddAnyCors(); app.UseAnyCors();</li><li>处理自定义模型校验返回状态码为200的错误情况</li><li>处理自定义模型校验和自定义返回类一起使用导致重复包装的问题</li></ul></li><li><p>0.0.1-beat2</p><ul><li>将关于swagger的东西去掉</li><li>优化扩展方法命名空间，正规化</li></ul></li><li><p>0.0.1-beta1</p><ul><li>从common里面移出来一些方法</li></ul></li></ul>`,64),t=[l];function r(d,o){return n(),s("div",null,t)}const p=e(i,[["render",r],["__file","common_mvc.html.vue"]]);export{p as default};
