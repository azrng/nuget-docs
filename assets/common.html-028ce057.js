import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,a as s}from"./app-dfa24dce.js";const a={},l=s(`<h2 id="common-core" tabindex="-1"><a class="header-anchor" href="#common-core" aria-hidden="true">#</a> Common.Core</h2><h3 id="操作" tabindex="-1"><a class="header-anchor" href="#操作" aria-hidden="true">#</a> 操作</h3><h4 id="objectextensions" tabindex="-1"><a class="header-anchor" href="#objectextensions" aria-hidden="true">#</a> ObjectExtensions</h4><p>模型类转url参数格式(1.0.5)</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>var userInfo = new UserInfoDto { Id = 1, Name = &quot;Test&quot;, };
// 参数不转小写
