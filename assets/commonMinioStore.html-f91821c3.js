import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-d2491ccc.js";const i={},t=e(`<h2 id="common-s3" tabindex="-1"><a class="header-anchor" href="#common-s3" aria-hidden="true">#</a> Common.S3</h2><p>一个基于AWSSDK.S3包适用于S3协议的存储封装类库。</p><h3 id="操作示例" tabindex="-1"><a class="header-anchor" href="#操作示例" aria-hidden="true">#</a> 操作示例</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>services.AddS3Store(x =&gt;
{
